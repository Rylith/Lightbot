...
import Orders.Jump;
import Orders.Light;
import Orders.MallocPointer;
import Orders.Move;
import Orders.Order;
import Orders.Procedure1;
import Orders.Procedure2;
import Orders.RemoveColor;
import Orders.TurnLeft;
import Orders.TurnRight;
import Orders.getColor;
...
/** ---------------- METHODS ----------------- */
	...
	public void resetGame() {
		...
		for(String mapKey : m_character.keySet()) {
			if (m_character.get(mapKey).getActif()) {
