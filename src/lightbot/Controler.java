...
/** -------------- CONSTRUCTORS -------------- */
	...
	public Controler(){
		...
		Button b_turnRight = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + SIZEBUTTONORDER.x + DECALBUTTON ,POSINITBUTTON.y), ButtonType.TurnRight, true); //Tourner droite
		Button b_turnLeft = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + ((SIZEBUTTONORDER.x + DECALBUTTON) * 2),POSINITBUTTON.y), ButtonType.TurnLeft, true); //Tourner gauche
		Button b_jump = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + ((SIZEBUTTONORDER.x + DECALBUTTON) * 3),POSINITBUTTON.y), ButtonType.Jump, true); //Sauter
		Button b_light = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + ((SIZEBUTTONORDER.x + DECALBUTTON) * 4),POSINITBUTTON.y), ButtonType.Light, true); //Allumer
		Button b_for = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + ((SIZEBUTTONORDER.x + DECALBUTTON) * 5),POSINITBUTTON.y), ButtonType.For, true); //For
		Button b_putP = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + ((SIZEBUTTONORDER.x + DECALBUTTON) * 6),POSINITBUTTON.y), ButtonType.PutP, true); //Poser pointeur
		Button b_useP = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + ((SIZEBUTTONORDER.x + DECALBUTTON) * 7),POSINITBUTTON.y), ButtonType.UseP, true); //Utiliser pointeur
		Button b_paint = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + ((SIZEBUTTONORDER.x + DECALBUTTON) * 8),POSINITBUTTON.y), ButtonType.Paint, true); //Se peindre
		Button b_removeColor = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + ((SIZEBUTTONORDER.x + DECALBUTTON) * 9),POSINITBUTTON.y), ButtonType.RemoveColor, true); //Se laver
		Button b_p1 = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + ((SIZEBUTTONORDER.x + DECALBUTTON) * 10),POSINITBUTTON.y), ButtonType.P1, true); //P1
		Button b_p2 = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTON.x + ((SIZEBUTTONORDER.x + DECALBUTTON) * 11),POSINITBUTTON.y), ButtonType.P2, true); //P2
		// Boutons representants les Bots
		Button b_basicBot = new Button(TILEPATHACTION, POSINITONGLETBOT, ButtonType.BasicBot, false); //SmartBot [presse]
		Button b_smartBot = new Button(TILEPATHACTION, new Vector2f(POSINITONGLETBOT.x + SIZEONGLETBOT.x, POSINITONGLETBOT.y), ButtonType.SmartBot, false); //BasicBot [non presse]
		// Boutons representants les couleurs des pointeurs et instructions
		Button b_green = new Button(TILEPATHACTION, POSINITBUTTONPOINTER, ButtonType.PushGreen, false); //Bouton vert [presse]
		Button b_yellow = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTONPOINTER.x + SIZEBUTTONCOLOR.x, POSINITBUTTONPOINTER.y), ButtonType.PushYellow, false); //Bouton jaune [non presse]
		Button b_red = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTONPOINTER.x + (SIZEBUTTONCOLOR.x * 2), POSINITBUTTONPOINTER.y), ButtonType.PushRed, false); //Bouton rouge [non presse]
		Button b_blue = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTONPOINTER.x + (SIZEBUTTONCOLOR.x * 3), POSINITBUTTONPOINTER.y), ButtonType.PushBlue, false); //Bouton bleue [non presse]
		
		Button b_grey = new Button(TILEPATHACTION, POSINITBUTTONCOLOR, ButtonType.PushGrey, false); //Bouton gris [presse]
		Button b_magenta = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTONCOLOR.x , POSINITBUTTONCOLOR.y + SIZEBUTTONCOLOR.y), ButtonType.PushMagenta, false); //Bouton magenta [non presse]
		Button b_cyan = new Button(TILEPATHACTION, new Vector2f(POSINITBUTTONCOLOR.x , POSINITBUTTONCOLOR.y + (SIZEBUTTONCOLOR.y * 2)), ButtonType.PushCyan, false); //Bouton cyan [non presse]
		
		//Boutons run
		Button b_run = new Button(TILEPATHACTION, POSINITBUTTONSTARTSTOP, ButtonType.Run, false); //Bouton run
		
		// Frames
		Frame f_main = new Frame(TILEPATHFRAME+"BackProc.png", POSINITFRAMEMAIN, FrameType.Main); //Main
		Frame f_p1 = new Frame(TILEPATHFRAME+"BackProc.png", new Vector2f(POSINITFRAMEMAIN.x , POSINITFRAMEMAIN.y + DECALFRAME), FrameType.P1); //P1
		Frame f_p2 = new Frame(TILEPATHFRAME+"BackProc.png", new Vector2f(POSINITFRAMEMAIN.x , POSINITFRAMEMAIN.y + (DECALFRAME * 2)), FrameType.P2); //P2
		Frame f_orderList = new Frame(TILEPATHFRAME+"BackOrder.png", POSINITFRAMEORDER, FrameType.OrderList); //OrderList
		
		// BackOrder & BackMain
		m_backMain = new Component(TILEPATHFRAME+"BackAllProc.png",POSINITBAKMAIN);
		m_backOrder = new Component(TILEPATHFRAME+"BackOrder.png",POSINITBACKORDER);
...
/** ---------- Supervision de deux Bots ----------------- */
	...
	public void init(Character BasicBot, Character SmartBot/*, Map map*/){
		Vector2f pos = new Vector2f(POSINITCADREMAIN.x,POSINITCADREMAIN.y);
		Character currentChar;
		for (int g = 0; g < 2 ; g++) {
			for (int j = 0; j < NUMBERFRAME; j++) {
				switch(j) {
				case 0:
					pos = new Vector2f(pos.x,POSINITCADREMAIN.y + (DECALFRAME * j));
					break;
				case 1:
					pos = new Vector2f(pos.x,POSINITCADREP1.y + (DECALFRAME * j));
					break;
				case 2:
					pos = new Vector2f(pos.x,POSINITCADREP2.y + (DECALFRAME * j));
					break;
				}
